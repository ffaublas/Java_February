...
import com.faublas.bookclub.models.LoginUser;
import com.faublas.bookclub.models.User;
import com.faublas.bookclub.services.BookService;
import com.faublas.bookclub.services.UserService;
...
public class HomeController {
    ...
    public String home(HttpSession session, Model model) {
    		...
    		//get all the startup books from the service
    ...
    public String logout(HttpSession session) {
    		session.invalidate(); //clear out the session so it doesn't store the user as logged in anymore
